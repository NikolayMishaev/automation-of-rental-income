...
const avatarDownloadBtn = document.querySelector(".modal-edit-avatar__download-btn input");
const avatarContainer = document.querySelector(".modal-edit-avatar .modal__body");
const modalAvatar = document.querySelector(".modal-edit-avatar");
const editAvatarBtn = document.querySelector(".icon_edit-avatar");

editAvatarBtn.addEventListener("click", () => (modalAvatar.style.display = "flex"));

avatarDownloadBtn.addEventListener("change", (e) => downloadAvatar(e));
let avatarCropp = null;

function downloadAvatar(e) {
  let lastAvatar = document.querySelector(".croppie-container");
  ...
  avatarCropp = new Croppie(img, {
    enableExif: true,
    viewport: { width: 300, height: 300, type: "circle" },
    boundary: { width: 572, height: 321 },
  ...
  reader.onloadend = function () {
    ...
    avatarCropp.bind({ url: reader.result });
  };
...
async function sendAvatar() {
  let avatar = await avatarCropp.result("blob");
  // TODO сменить url
...
const currentAvatar = document.querySelector(".prof-general__photo");
...
saveAvatarBtn.addEventListener("click", sendAvatar);
